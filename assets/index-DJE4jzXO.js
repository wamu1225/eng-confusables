...
🎯 覚え方：**out of＝中身が尽きて空になる（使い果たす）**、**down＝下へ落ちていく（消耗する・けなす・ひく）**。`,keyPoints:[`run out of＝（人が）〜を使い果たす（use up）。主語は使う側、目的語は消費されるもの`,`run down＝（電池等が）消耗して止まる／（人を）けなす／（車で）ひく。文脈で意味が変わる多義語`,`run out of は他動詞的構文で of の後に目的語が必須`,`out of＝中身が尽きて空になる、down＝下方へ落ちる、という前置詞イメージの違い`],quiz:[{id:`q-runoutof-1`,question:`空所に入る適切な語はどれですか。「We ( ) gas halfway through the trip.」`,options:[`ran down`,`ran out of`,`ran into`,`ran through`],correctAnswer:1,explanation:`使い果たしたのは run out of。`},{id:`q-runoutof-2`,question:`空所に入る適切な語はどれですか。「My phone battery has completely ( ).」`,options:[`run out of`,`run down`,`run into`,`run through`],correctAnswer:1,explanation:`電池が切れたのは run down（自動詞）。`},{id:`q-runoutof-3`,question:`空所に入る適切な語はどれですか。「He’s always ( ) his colleagues behind their backs.」`,options:[`running out of`,`running through`,`running down`,`running into`],correctAnswer:2,explanation:`人をけなすのは run down（他動詞）。`},{id:`q-runoutof-4`,question:`run out of の言い換えとして最も適切なものはどれですか。`,options:[`use up`,`criticize`,`hit`,`wear out`],correctAnswer:0,explanation:`run out of は use up（使い果たす）に置換できます。`},{id:`q-runoutof-5`,question:`run out of の文型として正しいものはどれですか。`,options:[`主語＝使う側の人、目的語＝消費されるもの`,`主語＝消費されるもの、目的語＝人`,`目的語をとらない自動詞のみ`,`受動態にしかならない`],correctAnswer:0,explanation:`run out of は「人がものを使い果たす」という他動詞的構文です。`}]}],c={1:`スペルが似ている語`,2:`意味が近く使い分けが難しい語`,3:`品詞・派生でまぎらわしい語`,4:`発音が似ている語`,5:`熟語・句動詞でまぎらわしいもの`},l={audience:`大学受験・TOEIC・英検の学習者、英語を学び直す社会人`,approach:`一対一の和訳暗記ではなく、意味の核と使い分けを比較表とミニ問題で身につける`},u=[{id:`take`,verb:`take`,title:`take を使った紛らわしい熟語・句動詞`,description:`take の中心イメージ「手を伸ばして自分の側に取り込む」が、続く前置詞・副詞でどう枝分かれするかをまとめたハブページ。`,content:`## take の中心イメージ
