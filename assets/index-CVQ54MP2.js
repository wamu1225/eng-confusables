...
bring about は「周囲の現実世界に、今まで無かった事象を発生させる」イメージで、主語には政策や技術革新のような抽象的な原因が来ます。bring around は「相手の意識をぐるりと回転させて、自分の立場へ向かわせる」イメージで、説得の場面と、気絶した人を正気に戻す場面の両方で使われます。`,previewPairs:[`bring about vs bring around（引き起こす／説得する）`,`bring on vs bring up（もたらす／育てる・話題に挙げる）`]},{id:`call`,verb:`call`,title:`call を使った紛らわしい熟語・句動詞`,description:`call の中心イメージ「声を出して呼ぶ」が、続く前置詞・副詞でどう枝分かれするかをまとめたハブページ。`,content:`## call の中心イメージ
...
put off は「今の時点から期日を遠ざけて置く」イメージで延期を表し、そこから「気持ちを遠ざける＝嫌にさせる」という意味にも広がります。put across は「意味を相手側へ渡し切る」イメージで伝達の成功を表し、put up with は「負担と同じ場所に立ち続けて耐える」というイメージから our（我慢する）の意味になります。`,previewPairs:[`put off vs put across（延期する／わかりやすく伝える）`,`put up with vs put up（我慢する／掲げる・宿泊させる）`]},{id:`get`,verb:`get`,title:`get を使った紛らわしい熟語・句動詞`,description:`get の中心イメージ「（努力して）手に入れる・ある状態に至る」が、続く前置詞・副詞でどう枝分かれするかをまとめたハブページ。`,content:`## get の中心イメージ
...
get over は山を「越える」イメージで、病気や失恋のような一時的な困難を乗り越える場面に使います。get through はトンネルのように「通り抜ける」イメージで、長く続く試験や困難な期間を耐え抜く場面に向きます。get around は障害物を迂回するイメージから「規則をすり抜ける」という意味に転じ、get along with は「相手と歩調を合わせて並んで進む」ことから人間関係の良好さを表します。`,previewPairs:[`get over vs get through（乗り越える／切り抜ける）`,`get around vs get along with（回避する／うまくやる）`]},{id:`run`,verb:`run`,title:`run を使った紛らわしい熟語・句動詞`,description:`run の中心イメージ「走る・流れるように進む」が、続く前置詞・副詞でどう枝分かれするかをまとめたハブページ。`,content:`## run の中心イメージ
...
hold off は「相手を自分から距離を置いた場所に留め置く」イメージで、決断の先延ばしにも敵の足止めにも使われます。hold out は「限界まで手を伸ばして持ちこたえる」イメージで、包囲されても抵抗を続ける場面が典型例です。hold up は「その場に立ち止まらせる」イメージから交通渋滞による遅延を表す一方、強盗が「動くな」と相手を止める場面（held up at gunpoint）にも使われる語です。`,previewPairs:[`hold off vs hold out vs hold up（延期する・防ぐ／持ちこたえる／遅らせる・強盗に入る）`,`hold up vs hold back（遅らせる／感情や情報を抑える）`]},{id:`set`,verb:`set`,title:`set を使った紛らわしい熟語・句動詞`,description:`set の中心イメージ「ある位置・状態に据える」が、続く前置詞・副詞でどう枝分かれするかをまとめたハブページ。`,content:`## set の中心イメージ
...
make up for は「不足していた分を新たに作り出して埋め合わせる」イメージで、失われたものの補償を表します。make do with は「理想ではないが今あるもので何とかする」という妥協のニュアンスを持ち、make out は「ぼんやりしたものの輪郭を作り出して判別する」ことから、視覚的・意味的な理解の両方に使われます。`,previewPairs:[`make up for vs make do with（補う／代用してすませる）`,`make out vs make for（理解する・判別する／向かって進む）`]},{id:`pass`,verb:`pass`,title:`pass を使った紛らわしい熟語・句動詞`,description:`pass の中心イメージ「通り過ぎる」が、続く前置詞・副詞でどう枝分かれするかをまとめたハブページ。`,content:`## pass の中心イメージ
