...
💡 フック：bo**rrow** は「（受け取って後で）返す（return）」イメージ、**l**end は **l**oan（貸付）の l。活用は lend-**lent**-lent（不規則）、borrow-borrowed-borrowed（規則）。`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['金額が大きければ lend', '主語が受け取る人なら borrow、渡す人なら lend', 'borrow はいつも過去形', 'どちらも「貸す」'],
        correctAnswer: 1,
...
🎯 覚え方：**数えられる → fewer（複数の s と相性）**、**量・かたまり → less**。迷ったら「複数形にできる名詞か」を確認。※口語では many の量にも less を使うことがありますが、試験では原則どおり fewer + 可算 を選びます。`,
    keyPoints: [
      'fewer＝可算名詞（複数）に「より少ない数」',
      'less＝不可算名詞に「より少ない量」',
      '判断の鍵：後ろの名詞が数えられるか',
    ],
    quiz: [
      ...
      {
        id: 'q-fewer-3',
        question: '数えられる名詞（可算・複数）に付くのはどちらですか。',
        options: ['fewer', 'less', 'どちらも', 'どちらも違う'],
        correctAnswer: 0,
        explanation: '可算・複数には fewer。不可算には less です。',
      },
      {
        id: 'q-fewer-4',
...
🎯 覚え方：**はっきり区別できる相手（多くは2つ）→ between**、**ひとまとまりの集団の中 → among**。国どうしの個別の関係のように、3つ以上でも個々を区別するなら between も使えます。`,
    keyPoints: [
      'between＝2つ、または個々に区別できる複数の間',
      'among＝3つ以上の不特定の集団の中',
      '鍵：対象を個別に見るか、集団として見るか',
    ],
    quiz: [
      {
        id: 'q-among-1',
      ...
      {
        id: 'q-among-3',
        question: '「2つのものの間」に主に使うのはどちらですか。',
        options: ['among', 'between', 'どちらも', 'どちらも違う'],
        correctAnswer: 1,
        explanation: '2つ（や個別の複数）の間は between。集団の中は among です。',
      },
      {
        id: 'q-among-4',
...
🎯 覚え方：**come（来る）の仲間が bring、go（行く）の仲間が take**。聞き手のいる場所へなら bring も使えます。要は「どこを基準に近づく／離れるか」。`,
    keyPoints: [
    ...
    quiz: [
      ...
      {
        id: 'q-bring-3',
        question: 'come（来る）と同じ向きの「持ってくる」はどちらですか。',
        options: ['take', 'bring', 'どちらも', 'どちらも違う'],
        correctAnswer: 1,
        explanation: 'bring は come の仲間（こちらへ）。take は go の仲間（あちらへ）です。',
      },
      {
        id: 'q-bring-4',
...
🎯 覚え方：**remind は re-mind＝人の心（mind）に働きかけて「思い出させる」**。remember は自分の中の記憶。目的語に「人」をとり「思い出させる」なら remind。`,
    keyPoints: [
      'remember＝自分が「思い出す・覚えている」',
      'remind＝人に「思い出させる」（remind 人 of / to do）',
      'remind は re-mind（人の心に働きかける）',
    ],
    quiz: [
      {
        id: 'q-remember-1',
      ...
      {
        id: 'q-remember-3',
        question: '「人に思い出させる」という意味の語はどれですか。',
        options: ['remind', 'remember', 'どちらも', 'どちらも違う'],
        correctAnswer: 0,
        explanation: '人に思い出させるのは remind。自分が思い出すのは remember です。',
      },
      {
        id: 'q-remember-4',
...
🎯 覚え方：**hear は勝手に「聞こえる」、listen は自分から「聞きにいく」**。listen は目的語の前に to が必要（listen to the radio）。`,
    keyPoints: [
      'hear＝自然に「聞こえる」（hear-heard-heard）',
      'listen＝意識して「聞く」（listen to ~）',
      'listen は to が必要、hear は不要',
    ],
    quiz: [
      {
        id: 'q-hear-1',
      ...
      {
        id: 'q-hear-3',
        question: 'あとに to をとって「〜を聞く」となるのはどちらですか。',
        options: ['hear', 'listen', 'どちらも', 'どちらも違う'],
        correctAnswer: 1,
        explanation: 'listen to ~。hear は to をとりません。',
      },
      {
        id: 'q-hear-4',
...
🎯 覚え方：**teach は「与える（give）」側、learn は「受け取る（get）」側**。「〜に教える」は teach、「〜を学ぶ・身につける」は learn。日本語の「教わる」に learn を当てる誤りに注意。`,
    keyPoints: [
      'teach＝（人に）教える（teach-taught-taught）',
      'learn＝（自分が）学ぶ・覚える（learn-learned/learnt）',
      '向き：teach は与える側、learn は受け取る側',
    ],
    quiz: [
      {
        id: 'q-teach-1',
      ...
      {
        id: 'q-teach-3',
        question: '「（自分が）学ぶ・覚える」を表すのはどちらですか。',
        options: ['learn', 'teach', 'どちらも', 'どちらも違う'],
        correctAnswer: 0,
        explanation: 'learn が学ぶ側。teach は教える側です。',
      },
      {
        id: 'q-teach-4',
...
🎯 覚え方：**look＝向ける、see＝入ってくる、watch＝追いかける**。静止画は look、風景は see、動画は watch。`,
    keyPoints: [
    ...
    quiz: [
      ...
      {
        id: 'q-look-5',
        question: '3語の使い分けとして正しい説明はどれですか。',
        options: ['look＝見える／see＝注視する／watch＝視線を向ける', '3語とも同じで交換できる', 'look＝視線を向ける／see＝目に入る／watch＝動くものを追う', 'watch は静止したものにだけ使う'],
        correctAnswer: 2,
        explanation: 'look は動作、see は知覚、watch は継続的な注視です。',
      },
    ],
  },
  {
