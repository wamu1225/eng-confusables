...
💡 フック：alt**er** は alt**er**native（別の・代わりの）と同じ alter- で「別のものに**変える**」動詞。alt**ar** は「祭壇という“もの”（名詞）」。`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['alternative（別の）の仲間', 'altitude（高度）', 'always（いつも）', 'almost（ほとんど）'],
        correctAnswer: 0,
...
🎯 precede は「前に**位置する**（順序が先）」、proceed は「前へ**動く**（先に進む）」。pre＝既に前にある、pro＝これから前方へ、と分けます。`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['pre＝前に、pro＝前方へ', 'pre＝前へ進む、pro＝前にある', 'pre＝後ろに、pro＝横に', 'どちらも「後ろ」'],
        correctAnswer: 0,
...
💡 フック：ex**c**ept は ex**c**lude（除外する）と同じ c で「除く」。expect は主語のあとに置く「動作（〜する）」＝動詞。空所が「動詞の位置」なら expect です。`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['expensive の p', 'expert の p', 'example の a', 'exclude の c（除く）'],
        correctAnswer: 3,
...
🎯 フック：capit**o**l の **o** は、議事堂の丸い**ドーム（dome）の O**。建物の話なら capitol、それ以外（首都・資本など）はほぼ capital。`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['a は apple の a', 'l が2つ', 't が2つ', 'o はドーム（dome）の O'],
        correctAnswer: 3,
...
💡 フック：discr**e**t**e** は、2つの e が真ん中の **t で分けられている**＝「分離した」。discr**ee**t は **ee がくっついて**「ひそひそ＝慎重」。`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['discrete は慎重な、discreet は分離した', 'discrete は e が t で分かれる＝分離、discreet は ee がくっつく＝慎重', 'どちらも「個別の」', 'どちらも「慎重な」'],
        correctAnswer: 1,
...
🎯 フック：**E**minent は **E**xcellent（卓越）の E、**I**mminent は **I**mmediate（即座・差し迫った）の I。頭文字で連想します。`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['eminent＝著名な（Excellent）、imminent＝差し迫った（Immediate）', 'eminent＝差し迫った、imminent＝著名な', 'どちらも「著名な」', 'どちらも「差し迫った」'],
        correctAnswer: 0,
