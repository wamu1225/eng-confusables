...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="90" y="160" font-family="${FONT}" font-size="54" font-weight="700" fill="#23272e">まぎらわしい英単語・熟語ノート</text>
  <text x="90" y="222" font-family="${FONT}" font-size="30" fill="#555b66">似た英単語・熟語を、引いて見分ける逆引きリファレンス</text>
